...
\newcommand{\Fine}[2]{\fbox{\makebox[#1][s]{\hbox to \parindent{}#2}}\\} % "F"irst Line
\newcommand{\Line}[2]{\fbox{\makebox[#1][s]{#2}}\\}
\begin{document}
\title{Modern Macros}
...
\begin{tikzpicture}[remember picture,overlay]
    \node[xshift=125mm,yshift=-155mm,anchor=north west] at (current page.north west){%
